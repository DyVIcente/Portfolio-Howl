import { piquante, kasa, yariga, kanap, pp, horace, metaversus, camsocial, githubProfile } from '../assets';
...
export const projects = [
    ...
    },
    {
      ...
      image: yariga,
      source_code_link: "https://github.com/DyVIcente/Yariga-Dashboard-Porperties",
    },
    {
      name: "Kanap",
      description:
    ...
    },
    {
      name: "Encore plus",
      description:
        "Pour voir plus de projets et ma Github Page.",
      tags: [
        {
          name: "Etc..",
          color: "text-black",
...
export const Recomendations = [
    ...
    {
      reco:
        "Dylan est aussi lumineux qu'un sortilège Lumos Maxima. Ses talents en développement sont époustouflants.",
